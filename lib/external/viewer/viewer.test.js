...
it('passes viewer attributes into the renderer options', async () => {
  const viewer = new ViewerComponent()
  const model = createElement('sol-model')
  const rendered = []

  viewer.setAttribute('axes', 'false')
  viewer.setAttribute('camera', 'perspective')
  viewer.setAttribute('edges', '')
  viewer.setAttribute('fit-margin', '3')
  viewer.setAttribute('grid', 'false')
  viewer.setAttribute('grid-size', '24')
  viewer.setAttribute('view', 'top')
  viewer.setAttribute('xray', 'true')
  viewer._viewer = {
    clear () {},
    render (result) {
  ...
  viewer.setAttribute('axes', '')
  viewer.setAttribute('camera', 'bad')
  viewer.setAttribute('edges', 'no')
  viewer.setAttribute('fit-margin', '0')
  viewer.setAttribute('grid', 'off')
  viewer.setAttribute('grid-size', '-2')
  viewer.setAttribute('view', 'bad')
  viewer.setAttribute('xray', '0')
