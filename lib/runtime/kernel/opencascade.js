...
function selectShapeEdges (edges, properties) {
  const indexes = selectedEdgeIndexes(properties, edges.length)
...
function selectedEdgeIndexes (properties, count) {
  ...
  return parseTopologySelector(selection, count)
}
...
function collectSelectedFaces (openCascade, value, properties) {
  ...
  const indexes = selectedFaceIndexes(properties, faceResult.faces.length)
...
function selectedFaceIndexes (properties, count) {
...
function parseTopologySelector (selection, count) {
