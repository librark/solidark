...
it('exports base component helpers', () => {
  ...
  assert.equal(typeof base.Kernel, 'function')
  assert.equal(typeof base.MemoryKernel, 'function')
  assert.equal(typeof base.createInMemoryKernel, 'function')
  assert.equal(typeof base.getGlobalKernel, 'function')
  assert.equal(typeof base.kernelMethodForTag, 'function')
