...
class ChildKindPart extends Component {
  static tag = 'child-kind-part'
...
it('Component decorates direct styling properties on kernel shapes', () => {
  ...
  try {
    ...
    const childKindShape = ChildKindPart.decorateKernelShape({
      tag: 'child-kind-part',
      properties: {},
      children: [{ geometryKind: 'sketch' }]
    })
    const multiChildKindShape = ChildKindPart.decorateKernelShape({
      tag: 'child-kind-part',
      properties: {},
      children: [{ geometryKind: 'sketch' }, { geometryKind: 'surface' }]
    })
    const missingChildKindShape = ChildKindPart.decorateKernelShape({
      tag: 'child-kind-part',
      properties: {},
      children: [{}]
    })
    ...
    assert.equal(childKindShape.geometryKind, 'sketch')
    assert.equal(multiChildKindShape.geometryKind, 'shape')
    assert.equal('geometryKind' in missingChildKindShape, false)
