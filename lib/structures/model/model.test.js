...
it('defines the model component metadata', () => {
  ...
  assert.equal(ModelComponent.shapeGeometryKind, 'shape')
  assert.deepEqual(ModelComponent.childGeometryKinds, ['geometry'])
  assert.equal(ModelComponent.shapeTag, 'sol-union')
  assert.equal(ModelComponent.shapeCategory, 'operation')
})
